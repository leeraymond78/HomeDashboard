...
const MESSAGES = {
  ja: {
    ...
    'traffic.title': '道路状況',
    'traffic.loading': '読み込み中…',
    'traffic.unavailable': '取得できません',
    'traffic.error': '道路データを取得できませんでした',
    'traffic.corridor': '260X ゴールドコースト／転乗駅 ⇄ 紅磡',
    'traffic.toTst': '紅磡方面（260X・廣東道）',
    'traffic.toGoldCoast': '屯門方面（260X・中間道／彌敦道）',
    'traffic.alongRoute': '往路の混雑（路段速度）',
    'traffic.news': '交通ニュース（黄金海岸〜転乗駅／260X）',
    'traffic.noNews': '該当区間の特別交通消息はありません',
    'traffic.noSegmentSpeeds': '路段速度データなし',
    'traffic.source': '資料：運輸署 TDAS / 交通檢測器 / 特別交通消息',
    'traffic.mins': '{count}分',
    'traffic.hours': '{hours}時間',
    'traffic.hoursMins': '{hours}時間{mins}分',
    'traffic.minSpeed': '最遅 {speed} km/h',
    'traffic.level.good': '順調',
    'traffic.level.moderate': 'やや混雑',
    'traffic.level.bad': '渋滞',
    'traffic.level.unknown': '不明',
    'traffic.etaUnavailable': '所要時間なし',
    'traffic.stale': '前回',
    'traffic.tdasPartial': '経路の所要時間は現在取得できません。路段速度と交通ニュースのみ表示しています。',
    'traffic.newsOnly': '交通ニュース',
    'traffic.map.tap': '地図で渋滞箇所を見る',
    'traffic.map.close': '閉じる',
    'traffic.map.hint': '路段速度（緑＝順調／黄＝やや混雑／赤＝渋滞）',
    'traffic.map.loading': '地図を読み込み中…',
    'traffic.map.progress': '路段 {loaded}/{total}',
    'traffic.map.ready': '{count}路段表示（渋滞 {slow}）',
    'traffic.map.noSegments': '表示できる路段がありません',
    'traffic.map.noHotspots': '顕著な渋滞路段はありません',
    'traffic.map.slowSegment': '{speed} km/h',
    'traffic.map.error': '地図データを取得できませんでした',
  ...
  en: {
    ...
    'traffic.title': 'Road traffic',
    'traffic.loading': 'Loading…',
    'traffic.unavailable': 'Unavailable',
    'traffic.error': 'Traffic data temporarily unavailable',
    'traffic.corridor': '260X · Gold Coast / BBI ⇄ Hung Hom',
    'traffic.toTst': 'To Hung Hom (260X · Canton Rd)',
    'traffic.toGoldCoast': 'To Tuen Mun (260X · Middle Rd / Nathan Rd)',
    'traffic.alongRoute': 'Outbound congestion (segment speeds)',
    'traffic.news': 'Traffic news (Gold Coast–BB Interchange / 260X)',
    'traffic.noNews': 'No special traffic news on this corridor',
    'traffic.noSegmentSpeeds': 'No segment speed data',
    'traffic.source': 'Source: TD TDAS / traffic detectors / special traffic news',
    'traffic.mins': '{count} min',
    'traffic.hours': '{hours} h',
    'traffic.hoursMins': '{hours} h {mins} min',
    'traffic.minSpeed': 'Slowest {speed} km/h',
    'traffic.level.good': 'Clear',
    'traffic.level.moderate': 'Busy',
    'traffic.level.bad': 'Congested',
    'traffic.level.unknown': 'Unknown',
    'traffic.etaUnavailable': 'ETA unavailable',
    'traffic.stale': 'cached',
    'traffic.tdasPartial': 'Drive times are not available right now. Showing segment speeds and traffic news only.',
    'traffic.newsOnly': 'Traffic news',
    'traffic.map.tap': 'Map: where is congested',
    'traffic.map.close': 'Close',
    'traffic.map.hint': 'Segment speeds (green = clear / yellow = busy / red = congested)',
    'traffic.map.loading': 'Loading map…',
    'traffic.map.progress': 'Segments {loaded}/{total}',
    'traffic.map.ready': '{count} segments ({slow} congested)',
    'traffic.map.noSegments': 'No segments to display',
    'traffic.map.noHotspots': 'No major congested segments',
    'traffic.map.slowSegment': '{speed} km/h',
    'traffic.map.error': 'Could not load map data',
